...
export const days = [
    ...
    >
        <section className="holly">
            ...
            <p>While walking today, I tried to really take in the sites, smells, and sounds of the trail…            </p>
            <ul>
            ...
            <p>We seem to have started a few Trail Rituals...            </p>
            <ul>
    ...
    >
        <section className="holly">
            <p>Well, we made it to high camp today, but not without some excitement…          </p>
    ...
    >
        <section className="holly">
            ...
            <p>Our day looked a little like this:            </p>
            <ul>
